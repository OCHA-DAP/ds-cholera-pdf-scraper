...
def run_extraction_pipeline(
    ...
    try:
        ...
        if len(df) == 0:
            ...
            print("1. JSON parsing failed (check logs for details)")
            print("2. The PDF format was unreadable")
            print("3. The model couldn't extract valid data")
            print()
            print("📝 Note: LLM call was logged to parquet for debugging")
            print("Continuing to upload logs...")
